...
class Dependency:
    def __init__(self, dep_from_task: int, dep_to_task: int, 
        ...
        self.dep_id = dep_id
        self.dep_from_task = dep_from_task
        self.dep_to_task = dep_to_task
...
class Project:
    def __init__(self):
        ...
        self.proj_dependencies: Dict[int, Dependency] = {}  # Dependency dict
        ...
        self._next_dep_id = 1 # Dependency counter
        
    def add_dependency(self, dep_from_task: int, dep_to_task: int, 
                       dep_type: str, dep_lag: float, dep_mandatory: bool = True):
        """
        Adds a dependency with an automatic ID.
        
        Args:
            dep_from_task: ID of the predecessor task
            dep_to_task: ID of the follower task
            dep_type: Dependency type ("FS", "SS", "FF", "SF")
            dep_lag: Lag in days
            dep_mandatory: Is the dependency mandatory
