...
ax.set_xticklabels(ax.get_xticklabels(), rotation=45, ha='right')  # поворот на 45 градусов
...
# s_skill = 1 / assigned_avg_efficiency (minimum 0.5, maximum 2.0 for realism)
s_skill = np.where(
...
plt.close()
print("Saved: baseline_comparison_rf.png")